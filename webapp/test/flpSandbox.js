		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#productividad-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"productividad-display": {
								"semanticObject": "productividad",
								"action": "display",
								"description": "Productividad y Eficiencia por ruta",
								"title": "Productividad y Eficiencia",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=productividad",
									"url": sap.ui.require.toUrl("productividad")
								}
							}
						}
					}
